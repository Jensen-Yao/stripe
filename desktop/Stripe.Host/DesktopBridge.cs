...
namespace Stripe.Host
{
    internal sealed class DesktopBridge
    {
        ...
        {
            PublicClient.DefaultRequestHeaders.UserAgent.ParseAdd("Stripe/0.3.9 satellite-planning-workbench");
        }
        ...
        private async Task<JToken> FetchSpaceTrackAsync(JObject query)
        {
            ...
            {
                client.DefaultRequestHeaders.UserAgent.ParseAdd("Stripe/0.3.9 satellite-planning-workbench");
